...
urlpatterns = [
    ...
    # 1-首页-搜索-商品详情(规格数据)
    path('goods_norms_data', Goods_norms_data.as_view()),
    # 1-首页-商品详情-加入购物车
    ...
    # 1-首页-提交订单
    path('submit_order_info', Submit_order_info.as_view()),
    ...
    # 7-前台管理-商品管理-一级规格添加
    path('goods_attribute_definition_add',
         Goods_attribute_definition_add.as_view()),
    # 7-前台管理-商品管理-二级规格添加
